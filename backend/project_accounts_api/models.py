...
class Location(models.Model):
    user=models.ForeignKey(User,on_delete=models.CASCADE)
    Location=models.CharField(unique=True,max_length=100,null=True,blank=True)
...
class Eventes(models.Model):
    ...
    adderss=models.ForeignKey(Location,on_delete=models.CASCADE)
...
class OrganizerDocuments(models.Model):
    user=models.ForeignKey(User,on_delete=models.CASCADE)
    image1=models.ImageField(upload_to='OrgDocImg/')
    image2=models.ImageField(upload_to='OrgDocImg/')
    image3=models.ImageField(upload_to='OrgDocImg/')
    image4=models.ImageField(upload_to='OrgDocImg/')
