...
class AddEventsView(generics.CreateAPIView):
    queryset=Eventes.objects.all()
...
class OrganizerDocumentsCreateAdmin(generics.ListAPIView):
    queryset=OrganizerDocuments.objects.all()
    serializer_class=OrganizerDocumentsSerializerAdmin
    def perform_create(self, serializer):
        serializer.save(user=self.request.user)

class OrganizerDocumentsCreate(generics.CreateAPIView,generics.ListAPIView):
    queryset=OrganizerDocuments.objects.all()
    serializer_class=OrganizerDocumentsSerializer
    def perform_create(self, serializer):
        serializer.save(user=self.request.user)

class OrganizerDocumentsDU(generics.DestroyAPIView,generics.UpdateAPIView):
    queryset=OrganizerDocuments.objects.all()
    serializer_class=OrganizerDocumentsSerializer
    lookup_field='id'
    def perform_create(self, serializer):
...
class LocationView(generics.CreateAPIView,generics.ListAPIView):
    queryset=Location.objects.all()
    serializer_class=LocationSerializer
    def perform_create(self, serializer):
        serializer.save(user=self.request.user)

class LocationViewDU(generics.DestroyAPIView,generics.UpdateAPIView):
    queryset=Location.objects.all()
    serializer_class=LocationSerializer
    lookup_field='id'
    def perform_create(self, serializer):
