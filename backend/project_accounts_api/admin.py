...
class OrganizerDocumentsAdmin(admin.ModelAdmin):
    list_display = ['image1','image2','image3','image4','user','companyName']

class genreEventes(admin.ModelAdmin):
    list_display = ['user','categry']

class locationEventes(admin.ModelAdmin):
...
admin.site.register(OrganizerDocuments,OrganizerDocumentsAdmin)
admin.site.register(Genre,genreEventes)
admin.site.register(Location,locationEventes)
