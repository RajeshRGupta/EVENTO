...
const CloseEvents = (props) => {
  ...
  useEffect(() => {
    console.log('hiii')
    const datedata = allEveData.filter((data1) => data1.deactivate === false).map((data) => data)
    console.log('datadfgh ',datedata)
  ...
  //       const datedata = response.data.filter((data1) => data1.deactivate === false).map((data) => data)
  //       setRecord(datedata.slice(firtIndex, lastIndex))
  //       setNPage(Math.ceil((datedata.length) / pageValue))
  //       setOnAddPageRef1(props.onAddPageRef)
  //     })
  ...
  // console.log('data,data,data,data,data,data,data,data,data,data,data,data,data,data,data,data,data,data,data,closed')
  // console.log(nPage)
            ...
            record.map((data, inx) => {
              return (
                <div className="row g-0 mt-3 position-relative" style={{ cursor: 'pointer' }} >
                  ...
                  <div className="col-11 h-100 position-absolute" style={{ top: 0, left: 0, zIndex: 50, backgroundColor: '#0000004a' }} onClick={() => { setShowUp(!showup); setDataId(data) }}></div>
                </div>
              )
            })
          }
